...
const formSchema = z.object({
	...
	squeegeeSpec: z.string().optional(),
...
export function SqueegeeUsageDialog({
	open,
	onOpenChange,
	onSubmit,
	isSubmitting,
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="sm:max-w-[820px]">
				<DialogHeader>
					<DialogTitle>新增刮刀使用记录</DialogTitle>
					<DialogDescription>记录刮刀使用次数、检查结果与责任人。</DialogDescription>
				</DialogHeader>
				<form
					onSubmit={(event) => {
				...
				>
					...
					<div className="grid gap-4 md:grid-cols-3">
						...
						<Field form={form} name="squeegeeSpec" label="刮刀规格 - 选填">
							{(field) => (
								<Input
									placeholder="例如: 350mm"
									value={field.state.value}
									onBlur={field.handleBlur}
									onChange={(e) => field.handleChange(e.target.value)}
								/>
