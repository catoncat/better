...
interface BakeRecordCardProps {
	record: BakeRecord;
}

export function BakeRecordCard({ record }: BakeRecordCardProps) {
	const primaryField = bakeRecordFieldMeta.find((field) => field.cardPrimary);
	const secondaryField = bakeRecordFieldMeta.find((field) => field.cardSecondary);
	const badgeField = bakeRecordFieldMeta.find((field) => field.cardBadge);
	const detailFields = bakeRecordFieldMeta.filter((field) => field.cardDetail);
