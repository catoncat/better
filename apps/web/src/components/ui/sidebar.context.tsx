...
function setSidebarCookie(value: boolean): void {
	// biome-ignore lint/suspicious/noDocumentCookie: Simple cookie for UI state persistence, Cookie Store API not widely supported
...
function SidebarProvider({
	...
	const [_open, _setOpen] = React.useState(() => {
		if (defaultOpen && openProp === undefined) {
