...
export const runSeedDcDemo = async ({ prisma, now, loadEnv }: SeedDcDemoOptions = {}) => {
	...
	// 创建单元 - 不同进度状态
	const unitStates = [
		{ sn: "SN-DC-DEMO-0001", status: db.UnitStatus.QUEUED, currentStepNo: 1, description: "待进站 (Step 1)" },
		{ sn: "SN-DC-DEMO-0002", status: db.UnitStatus.IN_STATION, currentStepNo: 1, description: "正在 PRINTING" },
		{ sn: "SN-DC-DEMO-0003", status: db.UnitStatus.IN_STATION, currentStepNo: 2, description: "正在 SPI" },
		{ sn: "SN-DC-DEMO-0004", status: db.UnitStatus.IN_STATION, currentStepNo: 4, description: "正在 REFLOW" },
		{ sn: "SN-DC-DEMO-0005", status: db.UnitStatus.IN_STATION, currentStepNo: 5, description: "正在 AOI (最后一站)" },
	];
