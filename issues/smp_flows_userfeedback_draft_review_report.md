...
核心问题：SMP 流程图是"活动图"而非"状态图"，与 MES 系统的状态机驱动模型存在本质差异。建议在保留当前活动描述的基础上，增加状态标注和异常分支，使其能够与 MES 系统的 TrackIn/TrackOut 和状态转换机制对接。