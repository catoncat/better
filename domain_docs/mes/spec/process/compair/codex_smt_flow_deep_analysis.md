...
- 客户流程以表单驱动为主，追溯颗粒度细，包含多类时间约束与多方签字。
...
| 首件检验 | 部分 | FAI 有数据模型，但缺多方签字与细项标准落地 |
...
| 多方确认 | QR-Pro-05 | Inspection.decidedBy | 缺多方 |
...
| 场景 | 客户要求 | 系统现状 | 差距 |
| --- | --- | --- | --- |
| 首件确认 | 生产/技术/质量 | 单一 decidedBy | 缺多签 |
| 转拉前检查 | 组长审核 | checkedBy 单签 | 缺复核 |
| 生产异常 | 异常确认 | 无 | 缺审批 |
...
| WP-5 转拉前检查 | QR-Pro-133 | ReadinessCheck/Item | 检查项模板 + 多签确认 |
| WP-6 FAI 多签与末件 | QR-Pro-05 | Inspection/InspectionItem | 多方签字 + 末件检查类型 |
