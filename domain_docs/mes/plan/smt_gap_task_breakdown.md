...
**T2.1 子任务**：
- [x] 2.1.1 设计 TimeRuleDefinition 模型
- [x] 2.1.2 设计 TimeRuleInstance 模型
- [x] 2.1.3 编写迁移脚本
- [x] 2.1.4 创建规则 CRUD API
- [x] 2.1.5 定义 TimeRuleConfig 配置模板（scope/事件/阈值/豁免）

**T2.2 子任务**：
- [x] 2.2.1 设计 Cron Job 扫描逻辑
- [x] 2.2.2 实现超时检测算法
- [x] 2.2.3 对接通知系统（Alert）
- [x] 2.2.4 实现豁免 API（time_rule:override 权限）
- [x] 2.2.5 明确起止事件采集点并接入（回流焊完成 / 水洗扫码）
